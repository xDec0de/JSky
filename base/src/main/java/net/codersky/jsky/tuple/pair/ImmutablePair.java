...
/**
 * An implementation of {@link Pair} that doesn't allow the modification of its elements, so it doesn't contain setters
 * as {@link MutablePair} does.
 *
...
public class ImmutablePair<F, S> implements Pair<F, S> {
    ...
    /**
     * Constructs a new {@link ImmutablePair} that contains two elements which may be {@code null}.
     *
