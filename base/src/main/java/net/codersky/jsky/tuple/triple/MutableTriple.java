...
/**
 * An implementation of {@link Triple} that allows changing the values of the stored elements, if you need these
 * elements to be final, use {@link ImmutableTriple}.
 *
...
public class MutableTriple<F, S, T> implements Triple<F, S, T> {
    ...
    /**
     * Constructs a new {@link ImmutableTriple} that contains three elements which may be {@code null}.
     *
    ...
    /**
     * Sets the first element stored on this {@link MutableTriple} to <b>first</b>, which can be {@code null}.
     *
    ...
    /**
     * Sets the second element stored on this {@link MutableTriple} to <b>second</b>, which can be {@code null}.
     *
    ...
    /**
     * Sets the third element stored on this {@link MutableTriple} to <b>third</b>, which can be {@code null}.
     *
