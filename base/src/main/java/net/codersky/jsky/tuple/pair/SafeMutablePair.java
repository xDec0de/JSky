...
/**
 * An extension of {@link MutablePair} that implements the {@link SafePair} interface, meaning that the elements stored
...
public class SafeMutablePair<F, S> extends MutablePair<F, S> implements SafePair<F, S> {
    ...
    /**
     * Constructs a new {@link SafeMutablePair} that contains two elements which can't be {@code null}.
     *
     * @param first the first element to store.
     * @param second the second element to store.
     *
     * @throws NullPointerException if either {@code first} or {@code second} are {@code null}.
     * @since JSky 1.0.0
     */
    ...
    /**
     * Gets the first element stored in this {@link SafeMutablePair}, which will <b>never</b> be {@code null}.
     *
     * @return The first element stored in this {@link SafeMutablePair}, never {@code null}
     *
     * @since JSky 1.0.0
     */
    @NotNull
    ...
    /**
     * Sets the first element stored on this {@link SafeMutablePair} to {@code first}, which can't be {@code null}.
     *
    ...
    /**
     * Gets the second element stored in this {@link SafeMutablePair}, which will <b>never</b> be {@code null}.
     *
     * @return The second element stored in this {@link SafeMutablePair}, never {@code null}
     *
     * @since JSky 1.0.0
     */
    @NotNull
    ...
    /**
     * Sets the second element stored on this {@link SafeMutablePair} to {@code second}, which can't be {@code null}.
     *
