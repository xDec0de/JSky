...
/**
 * An extension of {@link MutableTriple} that implements the {@link SafeTriple} interface, meaning that the elements
 * stored by this {@link Triple} cannot be {@code null}.
 *
...
public class SafeMutableTriple<F, S, T> extends MutableTriple<F, S, T> implements SafeTriple<F, S, T> {
    ...
    /**
     * Constructs a new {@link SafeMutableTriple} that contains two elements which can't be {@code null}.
     *
     * @param first the first element to store.
     * @param second the second element to store.
     * @param third the third element to store.
     *
     * @throws NullPointerException if either {@code first}, {@code second} or {@code third} are {@code null}.
     * @since JSky 1.0.0
     */
    ...
    /**
     * Gets the first element stored in this {@link SafeMutableTriple}, which will <b>never</b> be {@code null}.
     *
     * @return The first element stored in this {@link SafeMutableTriple}, never {@code null}
     *
     * @since JSky 1.0.0
     */
    @NotNull
    ...
    /**
     * Sets the first element stored on this {@link SafeMutableTriple} to {@code first}, which can't be {@code null}.
     *
    ...
    /**
     * Gets the second element stored in this {@link SafeMutableTriple}, which will <b>never</b> be {@code null}.
     *
     * @return The second element stored in this {@link SafeMutableTriple}, never {@code null}
     *
     * @since JSky 1.0.0
     */
    @NotNull
    ...
    /**
     * Sets the second element stored on this {@link SafeMutableTriple} to {@code second}, which can't be {@code null}.
     *
    ...
    /**
     * Gets the third element stored in this {@link SafeMutableTriple}, which will <b>never</b> be {@code null}.
     *
     * @return The third element stored in this {@link SafeMutableTriple}, never {@code null}
     *
     * @since JSky 1.0.0
     */
    @NotNull
    ...
    /**
     * Sets the third element stored on this {@link SafeMutableTriple} to {@code third}, which can't be {@code null}.
     *
