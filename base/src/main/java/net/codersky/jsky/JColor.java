...
public class JColor {
     ...
     *
     * @return {@code true} if {@code hex} follows the hex format explained above, {@code false} otherwise.
     *
     * @see #ofHex(String)
     * @see #isColor(String)
     * @since JSky 1.0.0
     ...
     *
     * @return A {@link Color} instance, given that {@code hex} follows the pattern mentioned above, {@code null}
     * otherwise.
     *
     * @see #isHex(String)
     * @see #of(String)
