...
/**
 * The most basic type of {@code abstract class} capable of providing data. This {@code class} is not capable of
 * <b>setting</b> data. For that, use a {@link DataManager}, as this is only designed to <b>provide</b> existing,
 * non-modifiable data.
 *
 * @author xDec0de_
 * @since JSky 1.0.0
...
public abstract class DataProvider {
    ...
    /**
     * Provides access to the <b>internal</b> {@link DataMap} that this {@link DataProvider} is using. Keep in mind once
     * again that this is for <b>internal</b> usage only, and you should not use it unless you <b>really</b> know what
     * you are doing. That being said, for any {@link DataProvider} extension that saves this map, please remember that
     * it features a {@link DataMap#isModified() modification} check and that you should
     * {@link DataMap#setModified(boolean) reset} it every time you save in order to avoid saving unmodified data.
     *
     * @return the <b>internal</b> {@link DataMap} that this {@link DataProvider} is using.
     *
     * @since JSky 1.0.0
     */
    @NotNull
    ...
    /**
     * Checks whether this {@link DataProvider} supports key nesting or not. Key nesting essentially means that keys can
     * have maps as a value, here is an example of key nesting:
     * <pre>
     * notNested: 1
     * key:
     *   nestedKey: 2
     *   anotherNestedKey: 3
     * </pre>
     * {@code notNested}'s key would be just <i>"notNested"</i>, however, {@code nestedKey}'s key would be
     * <i>"key.nestedKey"</i>. Internally, this means that {@code key}'s value is another map with its own keys.
     *
     * @return {@code true} if this {@link DataProvider} supports key nesting, {@code false} otherwise.
     */
    ...
    /**
     * Gets the {@link Set} of keys that are currently cached on this {@link DataProvider}. This set supports element
     * removal but not addition as explained on {@link HashMap#keySet()}. Elements removed from this {@link Set} will
     * also be removed from the storage cache. This can be used, for example to {@link Set#clear() clear} the file.
     *
     * @return The {@link Set} of keys that are currently cached on this {@link DataProvider}.
     *
     ...
     *
     * @return The stored {@link String} or {@code null} if {@code key} didn't exist or contains a different type of
     * value.
     *
