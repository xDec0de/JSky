...
/**
 * {@link Storage} class used to store data on simple flat files while trying to keep the size of said files to a
 * minimum. The data is stored as text without spaces nor indentation, supporting basic data types. About the memory
 * usage, this class only stores a {@link DataMap}, provided by {@link Storage}, and the {@link File} itself.
 *
 * @author xDec0de_
 * @since JSky 1.0.0
 */
