 ...
 * applications that want a lightweight logger that doesn't require any other dependencies.
 *
 * @author xDec0de_
 * @since JSky 1.0.0
 */
public class JLogger implements System.Logger {
    ...
    /**
     * Creates a new {@link JLogger} with the provided {@code name}. {@link Logger#getLogger(String)} is used to create
     * the internal logger, check that method for more details.
     *
    ...
    /**
     * Gets the current logging {@link Level level} of this {@link JLogger}. Messages sent to this logger that have a
     * lower {@link Level#getSeverity() severity} than the severity of this {@link Level level} will be discarded.
     *
    ...
    /**
     * Sets the logging {@link Level level} of this {@link JLogger} to the provided {@code level}. Messages with a lower
    ...
    /**
     * Checks whether the provided {@code level} would be logged or not according to the current log {@link Level level}
     * of this {@link JLogger}.
     *
     * @param level The {@link Level level} to check.
     *
     * @return {@code true} if a message at the provided {@code level} would be logged, {@code false} otherwise.
     *
     * @throws NullPointerException if {@code level} is {@code null}.
     * @since JSky 1.0.0
     */
    ...
    /**
     * Shortcut to {@link #setLevel(Level) set the level} of this {@link JLogger} to {@link Level#DEBUG DEBUG}.
     *
     * @return This {@link JLogger}
     *
     * @since JSky 1.0.0
    ...
    /**
     * Shortcut to {@link #setLevel(Level) set the level} of this {@link JLogger} to {@link Level#INFO INFO}.
     *
     * @return This {@link JLogger}
     *
     * @since JSky 1.0.0
    ...
    /**
     * Shortcut to {@link #setLevel(Level) set the level} of this {@link JLogger} to {@link Level#WARNING WARNING}.
     *
     * @return This {@link JLogger}
     *
     * @since JSky 1.0.0
    ...
    /**
     * Shortcut to {@link #setLevel(Level) set the level} of this {@link JLogger} to {@link Level#ERROR ERROR}.
     *
     * @return This {@link JLogger}
     *
     * @since JSky 1.0.0
