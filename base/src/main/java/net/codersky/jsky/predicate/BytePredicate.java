...
/**
 * Represents a predicate ({@code boolean}-valued function) of one {@code byte}-valued argument. This is the
 * {@code byte}-consuming primitive type specialization of {@link Predicate}.
 * <p>
...
public interface BytePredicate {
     ...
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link BytePredicate} is the first
     * to be evaluated, meaning that if this {@link BytePredicate} returns {@code false} or throws an exception, the
     ...
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link BytePredicate} is the first
     * to be evaluated, meaning that if this {@link BytePredicate} throws an exception, the {@code other} predicate
     * won't be evaluated.
     *
