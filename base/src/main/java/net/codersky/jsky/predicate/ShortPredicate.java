...
/**
 * Represents a predicate ({@code boolean}-valued function) of one {@code short}-valued argument. This is the
 * {@code short}-consuming primitive type specialization of {@link Predicate}.
 * <p>
...
public interface ShortPredicate {
    ...
    /**
     * Returns a composed predicate that represents a short-circuiting logical <b>AND</b> ({@code &&} operator) of this
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link ShortPredicate} is the first
     * to be evaluated, meaning that if this {@link ShortPredicate} returns {@code false} or throws an exception, the
    ...
    /**
     * Returns a composed predicate that represents a short-circuiting logical <b>OR</b> ({@code ||} operator) of this
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link ShortPredicate} is the first
     * to be evaluated, meaning that if this {@link ShortPredicate} throws an exception, the {@code other} predicate
     * won't be evaluated.
     *
