...
/**
 * Represents a predicate ({@code boolean}-valued function) of one {@code float}-valued argument. This is the
...
public interface FloatPredicate {
     ...
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link FloatPredicate} is the first
     * to be evaluated, meaning that if this {@link FloatPredicate} returns {@code false} or throws an exception, the
     ...
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link FloatPredicate} is the first
     * to be evaluated, meaning that if this {@link FloatPredicate} throws an exception, the {@code other} predicate
     * won't be evaluated.
     *
