...
/**
 * Represents a predicate ({@code boolean}-valued function) of one {@code char}-valued argument. This is the
 * {@code char}-consuming primitive type specialization of {@link Predicate}.
 * <p>
...
public interface CharPredicate {
     ...
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link CharPredicate} is the first
     * to be evaluated, meaning that if this {@link CharPredicate} returns {@code false} or throws an exception, the
     ...
     * predicate and the {@code other}. When evaluating the composed predicate, this {@link CharPredicate} is the first
     * to be evaluated, meaning that if this {@link CharPredicate} throws an exception, the {@code other} predicate
     * won't be evaluated.
     *
