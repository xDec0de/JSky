 ...
 * <p>
 * Please keep in mind that this class doesn't intend to replace {@link Collections} and the use of that class is
 * preferred over this one when possible, think of this class as an extension of said class, even though it doesn't
 * extend it (Because we can't).
 * <p>
...
public class JCollections {
    ...
    /**
     * Creates a new {@link Collection} of the same type as the first {@code collection}, containing all elements from
     * the given {@code collection} and all additional collections ({@code others}). All elements from
     * {@code collection} and each {@code others} collection are added in order to the new collection.
     * <p>
     * This method uses reflection to instantiate a new empty collection of the same type as {@code collection}.
     *
     * @param collection The base collection from which to derive the new collection type and whose elements are
     * included.
     ...
     *
     * @return A new {@link Collection} of the same type as {@code collection}, containing all elements from
     * {@code collection} and {@code others}. {@code null} if instantiation fails
     *
